...
//var postProcess = new BABYLON.BlackAndWhitePostProcess("bandw", 1.0, noa.camera.noa.rendering._camera);
  var time = 0;
    var rate = 0.01;
    ...
    var postEffect = new BABYLON.PostProcess("thanosEffect", "thanosEffect", ["time", "screenSize"], ["noiseRef0", "noiseRef1"], 1,noa.camera.noa.rendering._camera);
       
    var noiseTexture0 = new BABYLON.Texture('./texPack/'+funpack+'/textures/blocks/sand.png', scene);
    var noiseTexture1 = new BABYLON.Texture('./texPack/'+funpack+'/textures/blocks/sand.png', scene);
