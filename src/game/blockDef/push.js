...
export function pusher(noa,options,id,name,e){
...
var busmat1 = new BABYLON.StandardMaterial("face0", scene);
						busmat.diffuseTexture=bustex;
busmat1.backFaceCulling = false;
busmat1.specularColor = BABYLON.Color3.Black()
busmat1.emissiveColor = BABYLON.Color3.White()
...
bustex.hasAlpha=true;
						...
						BABYLON.SceneLoader.ImportMesh("", "","texPack/"+funpack+"/models/"+name+"/"+name+".babylon", scene, function (meshes) { 
						 mesh1= new BABYLON.Mesh("dummy", scene);
							   ...
							   meshes[0].material=busmat;
							  	meshes[1].material=busmat1;
	                            meshes[i].parent=mesh1;
							   meshes[1].material.diffuseTexture= new BABYLON.Texture("texPack/"+funpack+"/models/"+name+"/top.png", scene, false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
