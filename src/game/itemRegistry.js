...
export function  createItems(scene,name){
  ...
  blendMaterial.backFaceCulling = false;
	...
	//	blankmesh=BABYLON.Mesh.MergeMeshes([blankmesh,plane1,plane2], true, true, undefined, false, false)
		//	var offset = BABYLON.Matrix.Translation(0, 1, 0)
	      // blankmesh.bakeTransformIntoVertices(offset)
